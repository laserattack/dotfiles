...
#### Работа с директорией (oil)

- `space+e` - открыть/закрыть окошко с директорией
- `esc/q` - закрыть окошко с директорией
- `_` - перейти в рабочую директорию

С файлами/папками можно работать просто как с текстом
